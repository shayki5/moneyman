...
def create_new_sheet():
    spreadsheet = client.open('אוטומציה הוצאות 2026')
    ...
    spreadsheet = client.open('ניהול הוצאות הבית 2026')
...
#sum_category("אוטומציה הוצאות 2026", "current")

sheet_name = "ניהול הוצאות הבית 2026"
sheet1_title = "נוכחי"
current_date = datetime.now()
first_day_of_current_month = current_date.replace(day=1)
last_day_of_previous_month = first_day_of_current_month - timedelta(days=1)
